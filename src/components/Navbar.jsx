      ...
      <div className='flex items-center gap-4'>
        ...
        <div className={`${showMenu ? 'fixed w-full' : 'h-0 w-0'} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
          ...
          <ul className='flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium'>
            ...
            <NavLink onClick={() => setShowMenu(false)} to='/Chatbot'><p className='px-4 py-2 rounded inline-block'>AI Assistant</p></NavLink>
            <NavLink onClick={() => setShowMenu(false)} to='/HospitalLocator'><p className='px-4 py-2 rounded inline-block'>Nearest Hospital</p></NavLink>
